...
class Teacher extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'username', 'password', 'date_valid', 'is_deleted'
    ];
    ...
    public function subjects() {
        return $this->hasMany(TeacherSubject::class)->select('subject_id')->groupBy('subject_id');
    }

    public function classrooms() {
        return $this->hasMany(TeacherSubject::class)->select('classroom_id')->groupBy('classroom_id');
    }
