                              ...
                              <td>
                                  <div class="{{ $index === 0 ? 'droptop' : 'dropend' }}">
                                      ...
                                      <div class="dropdown-menu dropdown-menu-end">
                                          <a class="dropdown-item" target="_blank" href="{{ route('teacher.quiz.results', $item->activity_id) }}">
                                            <i data-feather="file-text"></i> Results
                                          </a>
                                          <a class="dropdown-item" target="_blank" href="{{ route('teacher.quiz.questions', $item->activity_id) }}">
...
<script>
    ...
    $('#add select[name=classroom]').on('change', function() {
        ...
        const newUri = uri.replace(/\/teacher\/quiz\/?/, "")
        $.ajax({
