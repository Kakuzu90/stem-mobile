...
@section('content')
  ...
  <form action="{{ route('teacher.student.answer_sheet', [$activity->id, $student->id, $classroom->id, $subject->id]) }}" method="POST">
    @csrf
    @method('PUT')
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-center align-items-center mb-1">
            <img src="{{ route('api.teacher.image', $question->with_image_path) }}" class="img-fluid" alt="Placeholder Image" />
          </div>
          @endif
          ...
          <div class="d-flex justify-content-center align-items-center flex-column mb-25">
            ...
            <img 
              src="{{ route('api.teacher.answer', $image) }}" 
              class="img-fluid rounded cursor-pointer open-img"
              data-item-src="{{ route('api.teacher.answer', $image) }}" 
